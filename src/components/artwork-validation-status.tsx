  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Artwork verification requires consensus from at least {validationStatus.required} validators
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">
                    Validation Progress: {validationStatus.completed} of {validationStatus.required}
                  </span>
                  <span className="text-sm text-gray-500">
                    {Math.round((validationStatus.completed / validationStatus.required) * 100)}%
                  </span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="border rounded-md p-4 text-center">
                  <div className="text-2xl font-bold text-green-600">{validationStatus.approved}</div>
                  <div className="text-sm text-gray-500">Approvals</div>
                </div>
                <div className="border rounded-md p-4 text-center">
                  <div className="text-2xl font-bold text-red-600">{validationStatus.rejected}</div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-md p-4">
                ...
                <ul className="text-sm text-gray-500 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Each artwork requires validation from at least {validationStatus.required} independent validators.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>Validators review the artwork, metadata, and AI analysis to make their decision.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>Consensus is reached when a majority of validators agree on the artwork's authenticity.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <TabsContent value="validators">
            <div className="space-y-4">
                ...
                <div className="border rounded-md overflow-hidden">
                  <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-gray-900">
                      <tr>
                        <th className="px-4 py-3 text-left text-sm font-medium">Validator</th>
                    ...
                    <tbody className="divide-y">
                      {validationStatus.validators.map((validator) => (
                        <tr key={validator.id} className="hover:bg-gray-50 dark:hover:bg-gray-900">
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <div>{getDecisionBadge(validator.decision)}</div>
                                </TooltipTrigger>
                                <TooltipContent>
                          ...
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-2">
                              ...
                              />
                              <span className="text-sm">{validator.reputation}</span>
                            </div>
                          </td>
                        </tr>
                      ))}
              ...
              {validationStatus.validators.length < validationStatus.required && (
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700 dark:text-yellow-400 mt-1">
                        {validationStatus.required - validationStatus.validators.length} more validators need to review
                        this artwork before consensus can be reached.
                      </p>
                    </div>
                  </div>
                </div>
